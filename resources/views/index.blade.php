...
<body>
    <section class="header">
        <div class="container">
            ...
            <p>spacious bungalows around malibu estate to let with big spacious rooms free access to electricity and
                water is available 24/7 join us in our visit in our weekly customer exposure around the houses</p>
                ...
                <div class="col-md-4">
                    <div class="varieties-box">
                        <div class="varieties-img">
                            <img src="{{ asset('images/download.jpeg') }}" alt="estate">
                        ...
                        <div class="varieties-details">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum laboriosam veniam ex
                                voluptatum maxime qui incidunt quaerat ad neque distinctio totam magni nesciunt, ea,
                                tempore dicta voluptate saepe quae reprehenderit!</p>
                        </div>
    ...
    <section class="gallery">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="gallery-box">
                        <img src="images/nikita.jpeg" alt="">
                        <h4>nikita</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="residents-review">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus rerum perferendis porro
                            illum adipisci ducimus fuga ut aliquid doloribus, beatae numquam ratione quibusdam, corrupti
                            eligendi, tenetur nesciunt nisi excepturi facilis?</p>
                        <h5>zafanana</h5>
